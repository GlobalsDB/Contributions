...
import com.intersys.globals.UndefinedException;
...
public class GlobalsDBGraphTest_ExSample {
    public GlobalsDBGraphTest_ExSample() {
    }
    ...
    public static void main(String[] args) {
        String[] args2 = { GlobalsDBGraphTest_ExSample.class.getName() };
    ...
    public void doExample() {
        ...
        try {
           ...
           /* When values stored as numeric types are retrieved as String, they are
            * converted into the String representations of the numeric values.
            */
           ...
           /* Attempt to get value of undefined node as byte[].
            */
           ...
           try {
              ...
              System.out.println("Somehow we got a double out of myUndefined");
           } catch (UndefinedException e) {
              System.out.println(
            ...
            * the NodeReference refers to the node with those subscripts across multiple
           ...
           /* The method exists() returns true if a node contains data, and false if it
           ...
           try {
              ...
              System.out.println("Second subscript, set as int, gotten as String: " +
           ...
           /* Or you can get all the items as Object[] in one method call, by calling
            * getAll():
            */
            ...
            * of String.  If you call getNextList for a list item that was not stored
            * as a ValueList, a GlobalsException is thrown.
            */
           ...
           System.out.println("\n********************************************************");
           mkGlobalWithNodesAndPrint(myArray);
           ...
           System.out.println("Value of the global \"myInt1\" after incrementing by 1: " +
                              myInt1.getInt());
           System.out.println("Retrieved incremented value is " + incrementedValue);
            ...
            * equivalent to set(N), so you don't have to worry about knowing whether
            ...
            * set as a type other than int or long, but if you do so, the results
            ...
            * returns the new (or previous) global name in collating order after
            ...
            */
            ...
            System.out.println(
               "transactionLevel() after calling Rollback() with arguments <= 0: " +
               connection.transactionLevel());
            connection.rollback();
            System.out.println("transactionLevel() after calling Rollback() no argument: " +
                               connection.transactionLevel());
             ...
             * that they can concurrently update the same globals, without
         ...
         */
           ...
           try {
              ...
              System.out.println("In 'finally' block while closing connection, caught GlobalsException: " + e.getMessage());
           }
        }
        }

    public void mkGlobalWithNodesAndPrint(NodeReference myArray) {
        ...
        GraphAPIEnv.printAllSubscripts (myArray);
    }
